...
namespace MonoGameLibrary.Graphics
{
    public class TextureAtlas
    {
        ...
        /// <summary>
        /// Gets the region from the texture atlas with the specified name.
        /// </summary>
        ...
        /// <summary>
        /// Removes the region from the texture atlas with the specified name.
        /// </summary>
        ...
        public static TextureAtlas FromFile(ContentManager content, string fileName)
        {
            ...
            using (Stream stream = TitleContainer.OpenStream(filePath))
            {
                using (XmlReader reader = XmlReader.Create(stream))
                {
                    ...
                    //<Texture> contains path for Texture2D to load, get that.
                    ...
                    //      </Animation>
                    // </Animations>
                    // add all animations, creating as needed
